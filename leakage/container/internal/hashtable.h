...
#ifndef _NONSTL_HASHTABLE_H
#define _NONSTL_HASHTABLE_H 1

#include "internal/hashtable_policy.h"
...
namespace base {
  ...
  template<typename _Key, typename _Value, typename _Allocator,
	...
	return static_cast<float>(size()) / static_cast<float>(bucket_count());
      ...
      base::pair<iterator, iterator>
      equal_range(const key_type& __k);

      base::pair<const_iterator, const_iterator>
	...
	_Insert_Return_Type;
      ...
      typedef typename std::conditional<__unique_keys,
					base::_Select1st<_Insert_Return_Type>,
					base::_Identity<_Insert_Return_Type>
				   >::type
	_Insert_Conv_Type;
  ...
  template<typename _Key, typename _Value,
	   ...
	   typename _H1, typename _H2, typename _Hash, typename _RehashPolicy,
	   bool __chc, bool __cit, bool __uk>
    base::pair<typename _Hashtable<_Key, _Value, _Allocator,
      ...
      if (__p)
	{
	  ...
	  return base::make_pair(__first, __last);
	}
      else
	return base::make_pair(this->end(), this->end());
    }
  ...
  template<typename _Key, typename _Value,
    ...
    template<typename _Arg>
      ...
      {
	base::pair<bool, std::size_t> __do_rehash
  ...
  template<typename _Key, typename _Value,
	...
	if (_Node* __p = _M_find_node(_M_buckets[__n], __k, __code))
	  return base::make_pair(iterator(__p, _M_buckets + __n), false);
	return base::make_pair(_M_insert_bucket(std::forward<_Arg>(__v),
			      __n, __code), true);
      }
  ...
  template<typename _Key, typename _Value,
      ...
      while (*__slot && this->_M_compare(__k, __code, *__slot))
	{
	  ...
	  // in parameters?
	  if (base::addressof(this->_M_extract((*__slot)->_M_v))
	      != base::addressof(__k))
	    {
	      _Node* __p = *__slot;
	      *__slot = __p->_M_next;
