...
#ifndef _NONSTL_HASHTABLE_POLICY_H
#define _NONSTL_HASHTABLE_POLICY_H 1
...
inline Type* addressof(Type &r) {
  return reinterpret_cast<Type*>(&const_cast<char&>(
...
namespace __detail {
  ...
  template<typename _Value, bool __constant_iterators, bool __cache>
    ...
    : public _Node_iterator_base<_Value, __cache>
    {
      ...
      pointer
      operator->() const
      { return base::addressof(this->_M_cur->_M_v); }
  ...
  template<typename _Value, bool __constant_iterators, bool __cache>
    ...
    : public _Hashtable_iterator_base<_Value, __cache>
    {
      ...
      pointer
      operator->() const
      { return base::addressof(this->_M_cur_node->_M_v); }
  ...
  inline base::pair<bool, std::size_t>
  _Prime_rehash_policy::
  _M_need_rehash(std::size_t __n_bkt, std::size_t __n_elt,
		 std::size_t __n_ins) const
  {
	...
	if (__min_bkts > __n_bkt)
	  {
	    ...
	    return base::make_pair(true, *__p);
	  }
	else
	  {
	    _M_next_resize = static_cast<std::size_t>
	      (__builtin_ceil(__n_bkt * _M_max_load_factor));
	    return base::make_pair(false, 0);
	  }
      }
    else
      return base::make_pair(false, 0);
  ...
  // Base classes for base::_Hashtable.  We define these base classes
  ...
  template<typename _Key, typename _Pair, typename _Hashtable>
    struct _Map_base<_Key, _Pair, base::_Select1st<_Pair>, false, _Hashtable>
    {
      typedef typename _Pair::second_type mapped_type;
    };

  template<typename _Key, typename _Pair, typename _Hashtable>
    struct _Map_base<_Key, _Pair, base::_Select1st<_Pair>, true, _Hashtable>
    {
      typedef typename _Pair::second_type mapped_type;
  ...
  template<typename _Key, typename _Pair, typename _Hashtable>
    typename _Map_base<_Key, _Pair, base::_Select1st<_Pair>,
		       true, _Hashtable>::mapped_type&
    _Map_base<_Key, _Pair, base::_Select1st<_Pair>, true, _Hashtable>::
    operator[](const _Key& __k)
    {
	...
	__h->_M_find_node(__h->_M_buckets[__n], __k, __code);
      if (!__p)
	return __h->_M_insert_bucket(base::make_pair(__k, mapped_type()),
				     __n, __code)->second;
  ...
  template<typename _Key, typename _Pair, typename _Hashtable>
	...
	__h->_M_find_node(__h->_M_buckets[__n], __k, __code);
      if (!__p)
	return __h->_M_insert_bucket(base::make_pair(std::move(__k),
						    mapped_type()),
				     __n, __code)->second;
      return (__p->_M_v).second;
    }
  ...
  template<typename _Key, typename _Pair, typename _Hashtable>
	...
	__h->_M_find_node(__h->_M_buckets[__n], __k, __code);
      if (!__p)
	      assert(false && (__N("_Map_base::at")));
      return (__p->_M_v).second;
    }

  template<typename _Key, typename _Pair, typename _Hashtable>
    const typename _Map_base<_Key, _Pair, base::_Select1st<_Pair>,
			     true, _Hashtable>::mapped_type&
    _Map_base<_Key, _Pair, base::_Select1st<_Pair>, true, _Hashtable>::
    at(const _Key& __k) const
    {
  ...
  // See base::is_permutation in N3068.
  template<typename _ExtractKey, typename _Hashtable>
    template<typename _Uiterator>
      bool
