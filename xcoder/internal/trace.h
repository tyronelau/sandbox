...
#define WEBRTC_TRACE (true) ? (void)0 : AgoraRTC::Trace::Add
#define WEBRTC_TRACE_STREAM (true) ? (void)0 : AgoraRTC::Trace::Add
#else
#define WEBRTC_TRACE AgoraRTC::Trace::Add
#define WEBRTC_TRACE_STREAM(...) if (false) AgoraRTC::Trace::Add(kTraceStream, ##__VA_ARGS__)
#define WEBRTC_TRACE_DBGINFO(...) if (false) AgoraRTC::Trace::Add(kTraceInfo, ##__VA_ARGS__)
//#define WEBRTC_TRACE_STREAM(...) AgoraRTC::Trace::Add(kTraceStream, ##__VA_ARGS__)
#endif
