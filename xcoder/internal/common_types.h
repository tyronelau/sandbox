...
namespace AgoraRTC {
  ...
  public:
    virtual int SendPacket(int channel, const void *data, int len,
      int frameType = 3, uint32_t frameNumber = 0xFFFFFFFF,
      int pack_num = 0, int seq_in_pack = 0, int streamType = 0) = 0;
  ...
  public:
    ...
    //       of AgoraRTC::kViEMaxMtu if you are encrypting in the video engine, or
    //       AgoraRTC::kVoiceEngineMaxIpPacketSizeBytes for the voice engine.
